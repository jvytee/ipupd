        ...
        Ok(config) => {
            ...
            println!(
                "Interface: {}\n\
                 ...
                 IPv6: {}\n",
                interface,
                interface_ips.v4.unwrap_or("None".to_string()),
                interface_ips.v6.unwrap_or("None".to_string())
            );
            ...
            println!(
                "Domain: {}\n\
                 ...
                 IPv6: {}",
                domain,
                domain_ips.v4.unwrap_or("None".to_string()),
                domain_ips.v6.unwrap_or("None".to_string())
            );
        }
        Err(error) => {
